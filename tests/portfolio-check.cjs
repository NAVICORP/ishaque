...
(async () => {
  ...
  const failed = results.some(result => {
    ...
    const expectedOgImage = result.page === 'projects'
      ...
      : { url: 'https://ishaquenv.com/assets/portfolio/og-image.png?v=20260823', width: '1290', height: '731' };
