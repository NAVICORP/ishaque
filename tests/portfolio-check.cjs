...
(async () => {
  ...
  const failed = results.some(result => {
    ...
    if (result.ogImage !== 'https://ishaquenv.com/assets/portfolio/og-image.png?v=20260823' || result.ogImageWidth !== '1290' || result.ogImageHeight !== '731' || result.twitterImage !== result.ogImage || result.twitterCard !== 'summary_large_image') return true;
